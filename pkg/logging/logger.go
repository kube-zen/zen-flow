...
// WithJobFlow adds JobFlow-related fields to the logger.
func (l *Logger) WithJobFlow(namespace, name string) *Logger {
	return l.WithFields(
		Field{Key: "jobflow_namespace", Value: namespace},
		Field{Key: "jobflow_name", Value: name},
	)
}

// WithStep adds step-related fields to the logger.
func (l *Logger) WithStep(stepName string) *Logger {
	return l.WithField("step_name", stepName)
}

// WithJob adds job-related fields to the logger.
func (l *Logger) WithJob(namespace, name string) *Logger {
	return l.WithFields(
		Field{Key: "job_namespace", Value: namespace},
		Field{Key: "job_name", Value: name},
	)
}
...
func getErrorType(err error) string {
	...
	var jferr *jferrors.JobFlowError
